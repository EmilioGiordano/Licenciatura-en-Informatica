...
2. **Multiprocessing**: Usando el módulo `multiprocessing`. crea varios procesos, cada uno con su propio intérprete de Python y memoria separada. No se limita por el *GIL*, pero resulta más pesado porque crea procesos que se inter-comunican. Útil para cálculos pesados y tareas CPU-bound.
